...
# It allows addition to indices without first having to create
#   a list of size `n` initialized with values 
#   (which are all going to be zero anyway).
# Inevitably there will be some items in a list data structure
